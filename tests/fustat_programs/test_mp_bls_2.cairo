...
from garaga_zero_src.src.definitions import bls, UInt384, one_E12D, E12D
from garaga_zero_src.src.test_utils import load_random_G1G2_pairs
from garaga_zero_src.src.bls12_381.multi_pairing_2 import multi_pairing_2P, G1G2Pair
...
func main{
    ...
    let (local res: E12D) = multi_pairing_2P(cast(inputs, G1G2Pair*));
    %{

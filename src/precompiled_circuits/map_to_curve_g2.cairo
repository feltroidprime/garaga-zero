...
func get_MAP_TO_CURVE_G2_FIN_QUAD_circuit(curve_id: felt) -> (circuit: ModuloCircuit*) {
    ...
    dw 184;
    dw 0;
    dw 192;  // Fp2 mul real part end
    dw 196;
    dw 188;
    dw 200;  // Fp2 mul imag part end
    dw 204;
    dw 208;
...
func get_MAP_TO_CURVE_G2_FIN_NON_QUAD_circuit(curve_id: felt) -> (circuit: ModuloCircuit*) {
    ...
    dw 252;
    dw 240;
    dw 260;  // Fp2 mul real part end
    dw 264;
    dw 256;
    dw 268;  // Fp2 mul imag part end
    dw 272;
    dw 276;
    dw 252;  // None
    dw 280;
    ...
    dw 288;
    dw 0;
    dw 296;  // Fp2 mul real part end
    dw 300;
    dw 292;
    dw 304;  // Fp2 mul imag part end
    dw 308;
    dw 312;
    dw 264;  // Fp2 add real part
    dw 300;
    dw 316;

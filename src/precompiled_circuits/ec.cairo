...
func get_FULL_ECIP_1P_circuit(curve_id: felt) -> (circuit: ModuloCircuit*) {
    ...
    dw 224;
    dw 476;
    dw 480;  // Eval sumdlogdiv_a_num Horner step: multiply by xA2
    dw 224;
    dw 484;
    ...
    dw 224;
    dw 508;
    dw 512;  // Eval sumdlogdiv_a_den Horner step: multiply by xA2
    dw 224;
    dw 516;
    dw 520;  // None
    dw 524;
    ...
    dw 224;
    dw 544;
    dw 548;  // Eval sumdlogdiv_b_num Horner step: multiply by xA2
    dw 224;
    dw 552;
    ...
    dw 224;
    dw 600;
    dw 604;  // Eval sumdlogdiv_b_den Horner step: multiply by xA2
    dw 224;
    dw 608;
    dw 612;  // None
    dw 616;
...
func get_FULL_ECIP_2P_circuit(curve_id: felt) -> (circuit: ModuloCircuit*) {
    ...
    dw 280;
    dw 572;
    dw 576;  // Eval sumdlogdiv_a_num Horner step: multiply by xA2
    dw 280;
    dw 580;
    ...
    dw 280;
    dw 612;
    dw 616;  // Eval sumdlogdiv_a_den Horner step: multiply by xA2
    dw 280;
    dw 620;
    dw 624;  // None
    dw 628;
    ...
    dw 280;
    dw 656;
    dw 660;  // Eval sumdlogdiv_b_num Horner step: multiply by xA2
    dw 280;
    dw 664;
    ...
    dw 280;
    dw 720;
    dw 724;  // Eval sumdlogdiv_b_den Horner step: multiply by xA2
    dw 280;
    dw 728;
    dw 732;  // None
    dw 736;
